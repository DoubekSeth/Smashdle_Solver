...
for (i in 2:starting_vertices_count){
  ...
  if(length(remaining_roster) == 1){
    ...
    remaining_roster_df = smashdle_csv[, (names(smashdle_csv$Character) in remaining_roster)]
...
#E(flowchart)$label = first_guess_combos[[2]]
plot(flowchart, layout = layout_nicely(flowchart))
```
