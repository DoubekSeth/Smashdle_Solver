...
#two_select_map = c("1" = "🟥", "2" = "🟩")
#three_select_map = c("1" = "🟥", "2" = "🟨", "3" = "🟩")
#up_down_map = c("1" = "⬇️", "2" = "⬆️", "3" = "🟩")
...
```
The lack of color and tools is really hurting the visualizations here, I think it's time to migrate to d3
```{r}
#Extract Data
nodes = as_data_frame(expanded_2_flowchart, what = "vertices")
edges = as_data_frame(expanded_2_flowchart, what = "edges")

export_list = list(nodes, edges)

write_json(export_list, "graph_data.json", pretty = TRUE)
```
