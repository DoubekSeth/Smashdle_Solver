...
```{r}
curr_state = get_state("Correct", "Correct", "Incorrect", "Lower", "Incorrect", "Incorrect", "Higher")
reduced_roster = reduce_state_with_prev_guess("Dr. Mario", curr_state, smashdle_csv)
#best_char(possible_state_combos, reduced_roster) Lucas
